...
class TelegramLLMRewriter(ILLMRewriter):
    ...
    async def rewrite(
        ...
        system = (
            ...
            "6. КЛЮЧОВІ ТЕГИ. Після основного тексту (і блоку «Довідково:», якщо є) "
            "додати на новому рядку:\n"
            "   Ключові теги: #тег1 #тег2 ...\n"
            "   Вимоги до тегів:\n"
            "   — від 5 до 10 тегів;\n"
            "   — мова — українська;\n"
            "   — формат — одне слово або злите словосполучення (camelCase), без пробілів;\n"
            "   — охоплювати: тему, ключових акторів, країну, галузь, тип події;\n"
            "   — не використовувати: #новини, #стаття, #огляд.\n\n"
            "ЗАБОРОНЕНО:\n"
