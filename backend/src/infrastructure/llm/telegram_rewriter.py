...
class TelegramLLMRewriter(ILLMRewriter):
    ...
    async def rewrite(
        ...
        system = (
            ...
            "4. ГРОШОВІ СУМИ. Вихідний текст містить еквіваленти у гривнях у дужках "
            "(приклад: «10 млн EUR (понад 4,6 млрд грн)»). Зберігати ці дужкові значення у вихідному вигляді, "
            "нічого не перераховувати.\n"
        ...
        user = (
            ...
            "Збережи всі суми у гривнях у дужках. Текст має бути максимально стислим та безоціночним."
        )
