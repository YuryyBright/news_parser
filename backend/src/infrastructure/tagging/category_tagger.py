...
Додатково:
  - "Україна" — якщо є сигнальні слова у тексті (EN/UA/HU/SK/RO/PL)
...
Мови keyword-правил: EN, UA, HU, SK, RO, PL.
...
_KEYWORD_RULES: list[tuple[str, list[str], int]] = [
    (
        ...
        [
            ...
            "ukraiński", "ukraińcy", "ukraińska", "kijowski",
            "zełenski", "lwów", "charków", "doniecki",
        ],
        1,
    ),
    (
        "кібербезпека", # 100% гарантія для хакерів та розробки
        [
            # UA
            "кібербезпека", "хакер", "злам", "взлом", "кібератака", "вірус", "витік даних",
            "кіберзлочин", "кіберзахист", "програмне забезпечення", "розробка", "програміст",
            "it-компанія", "ддос", "ddos", "фішинг",
            # EN / PL / HU / SK
            "cybersecurity", "hacker", "cyberattack", "malware", "ransomware", "phishing",
            "data breach", "software development", "programmer", "kiberbiztonság", "kibertámadás",
            "adatlopás", "kybernetická bezpečnosť", "kybernetický útok", "haker", "cyberatak",
            "wyciek danych", "oprogramowanie"
        ],
        1, # Достатньо 1 збігу для присвоєння тегу
    ),
    (
        "соціальна політика",
        [
            # UA (з фокусом на біженців та зв'язки)
            "соціальна політика", "пенсія", "охорона здоров'я", "освітня реформа",
            "соціальні виплати", "допомога біженцям", "українські біженці", "субсидії",
            "прожитковий мінімум", "виплати ВПО",
            # EN / PL / HU / SK
            "social policy", "welfare", "pension", "refugee support", "social assistance",
            "szociálpolitika", "nyugdíj", "ukrán menekültek", "szociális ellátás",
            "sociálna politika", "dôchodok", "podpora utečencov",
            "polityka społeczna", "emerytura", "uchodźcy z ukrainy", "zasiłek socjalny"
        ],
        2,
    ),
    (
        ...
        [
            # Фокус на внутрішню політику та вплив РФ
            "внутрішня політика", "національна політика", "вибори", "уряд", "парламент",
            "проросійський", "вплив рф", "російський вплив", "опозиція", "політична криза",
            "pro-russian", "russian influence", "domestic policy", "ruling party",
            "orosz befolyás", "ukránellenes", "belpolitika",
            "ruský vplyv", "domáca politika",
            "rosyjskie wpływy", "polityka krajowa", "wybory"
        ],
        2,
    ),
    (
        ...
        [
            ...
            "missile", "raketa", "rakéta", "rachetă", "artillery", "artilerie", 
            "czołg", "opancerzony", "śmigłowiec", "pocisk", "rakieta", "artyleria",
        ],
        2,
    ),
]
