        ...
        >
          ...
          {!isRead && onMarkRead && (
            <button
              ...
              className={cn(
                ...
                "text-slate-400 dark:text-slate-500 hover:text-emerald-600 hover:bg-emerald-50 dark:hover:bg-emerald-900/30",
              )}
            >
          ...
          <a
            ...
            className={cn(
              "p-1.5 rounded-md transition-all",
              "sm:opacity-0 sm:group-hover:opacity-100",
              "text-slate-400 dark:text-slate-500 hover:text-blue-500 hover:bg-blue-50 dark:hover:bg-blue-950/50",
            )}
          >
