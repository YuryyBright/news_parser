...
export const statusColor = (status: string): string => {
  const map: Record<string, string> = {
    ...
    accepted: 'text-emerald-600 bg-emerald-50 dark:bg-emerald-950 dark:text-emerald-400 border-emerald-200',
    rejected: 'text-red-500 bg-red-50 dark:bg-red-950 dark:text-red-400 border-red-200',
    expired: 'text-slate-400 bg-slate-50 dark:bg-slate-800 dark:text-slate-500 border-slate-200',
    processing: 'text-violet-600 bg-violet-50 dark:bg-violet-950 dark:text-violet-400 border-violet-200',
    unread: 'text-blue-600 bg-blue-50 dark:bg-blue-950 dark:text-blue-400 border-blue-200',
...
export const languageFlag = (lang: string): string => {
  const map: Record<string, string> = {
    uk: '🇺🇦',
    en: '🇬🇧',
    de: '🇩🇪',
